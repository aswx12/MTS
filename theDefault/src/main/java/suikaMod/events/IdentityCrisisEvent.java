...
import static suikaMod.DefaultMod.makeEventPath;
...
public class IdentityCrisisEvent extends AbstractImageEvent {
    ...
    private final int healthdamage; //The actual number of how much Max HP we're going to lose.
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("suikaModResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
