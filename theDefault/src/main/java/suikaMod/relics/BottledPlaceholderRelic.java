...
import suikaMod.patches.relics.BottledPlaceholderField;
import suikaMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static suikaMod.DefaultMod.makeRelicOutlinePath;
import static suikaMod.DefaultMod.makeRelicPath;
