...
@AutoAdd.Seen
public class fasffssf extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(fasffssf.class.getSimpleName()); 
    ...
    public fasffssf ()
    { 
        super(ID, "fasffssf", IMG,"Deal !D! damage", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
