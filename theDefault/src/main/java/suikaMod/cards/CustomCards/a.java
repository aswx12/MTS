...
public class a extends AbstractDynamicCard
{
    ...
    private int hADD_AMOUNT_RANDOM_POWER = 2;
    private final int UPGRADE_hAMOUNT_RANDOM_POWER = 3;
    ...
    public void use(AbstractPlayer p, AbstractMonster m)
    {
         ...
         AddRandomCardHand(hADD_AMOUNT_RANDOM_POWER,CardType.POWER);
    }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            hADD_AMOUNT_RANDOM_POWER=UPGRADE_hAMOUNT_RANDOM_POWER;
