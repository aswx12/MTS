...
@AutoAdd.Seen
public class gasgsas extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(gasgsas.class.getSimpleName()); 
    ...
    public gasgsas ()
    { 
        super(ID, "gasgsas", IMG,"gas", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
