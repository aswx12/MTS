...
@AutoAdd.Seen
public class asgsa extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(asgsa.class.getSimpleName()); 
    ...
    private static final int UPGRADE_PLUS_aVULNERABLE = 1;
    private static final int aWEAK = 1;
    private static final int UPGRADE_PLUS_aWEAK = 1;
    private static final int aPOISON = 1;
    private static final int UPGRADE_PLUS_aPOISON = 1;
    private static final int aSTR = 1;
    private static final int UPGRADE_PLUS_aSTR = 1;
    private static final int gVULNERABLE = 1;
    private static final int UPGRADE_PLUS_gVULNERABLE = 1;
    private static final int gWEAK = 1;
    private static final int UPGRADE_PLUS_gWEAK = 1;
    private static final int gPOISON = 1;
    private static final int UPGRADE_PLUS_gPOISON = 1;
    private static final int gSTR = 1;
    private static final int UPGRADE_PLUS_gSTR = 1;

    // /STAT DECLARATION/

    public asgsa ()
    { 
        super(ID, "asgsa", IMG,"a", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
        baseBlock = BLOCK;
