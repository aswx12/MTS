...
@AutoAdd.Seen
public class qwda extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(qwda.class.getSimpleName()); 
    ...
    public qwda ()
    { 
        super(ID, "qwda", IMG,"do !D!", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
