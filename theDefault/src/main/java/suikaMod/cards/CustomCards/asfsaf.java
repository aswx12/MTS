...
@AutoAdd.Seen
public class asfsaf extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(asfsaf.class.getSimpleName()); 
    ...
    public asfsaf ()
    { 
        super(ID, "asfsaf", IMG,"Deal !D! damage", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
