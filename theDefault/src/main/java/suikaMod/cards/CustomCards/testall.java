...
@AutoAdd.Seen
public class testall extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(testall.class.getSimpleName()); 
    ...
    public testall ()
    { 
        super(ID, "testall", IMG,"a", COST, TYPE, COLOR, RARITY, TARGET);
