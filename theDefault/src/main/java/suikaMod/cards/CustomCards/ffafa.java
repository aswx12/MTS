...
@AutoAdd.Seen
public class ffafa extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(ffafa.class.getSimpleName()); 
    ...
    public ffafa ()
    { 
        super(ID, "ffafa", IMG,"fwfasfasfsfa", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
