...
@AutoAdd.Seen
public class asgasg extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(asgasg.class.getSimpleName()); 
    ...
    public asgasg ()
    { 
        super(ID, "asgasg", IMG,"a", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
        baseBlock = BLOCK;
