...
@AutoAdd.Seen
public class faafafaf extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(faafafaf.class.getSimpleName()); 
    ...
    public faafafaf ()
    { 
        super(ID, "faafafaf", IMG,"a", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
        baseBlock = BLOCK;
