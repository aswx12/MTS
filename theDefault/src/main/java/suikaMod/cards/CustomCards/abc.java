...
@AutoAdd.Seen
public class abc extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(abc.class.getSimpleName()); 
    ...
    public abc ()
    { 
        super(ID, "abc", IMG,desc, COST, TYPE, COLOR, RARITY, TARGET);
