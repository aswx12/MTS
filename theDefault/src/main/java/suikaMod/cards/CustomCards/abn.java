...
@AutoAdd.Seen
public class abn extends AbstractDynamicCard
{
    public static final String ID = DefaultMod.makeID(abn.class.getSimpleName()); 
    ...
    public abn ()
    { 
        super(ID, "abn", IMG,desc, COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
