...
@AutoAdd.Seen
public class FirstCard extends AbstractDynamicCard
{
    ...
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID(FirstCard.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    { // public Suika() - This one and the one right under the imports are the most important ones, don't forget them
        super(ID, "FirstCard", IMG, "Suika card does !D!", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
