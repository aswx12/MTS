...
@AutoAdd.Seen
public class efef extends AbstractDynamicCard
{
    ...
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID(efef.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public static int DAMAGE = 111;    // DAMAGE = 2
    ...
    { // public Suika() - This one and the one right under the imports are the most important ones, don't forget them
        super(ID, "efef", IMG, "new efefe !D!", COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
